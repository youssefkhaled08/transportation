...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String TRAVELS_COLUMN_FROM = "FROM";
    public static final String TRAVELS_COLUMN_TO = "TO";
    public static final String TRAVELS_COLUMN_DATE = "DATE";
    public static final String TRAVELS_COLUMN_START = "START";
    public static final String TRAVELS_COLUMN_END = "END";
